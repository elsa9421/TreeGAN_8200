...
#         self._parser.add_argument('--DEGREE', type=int, default=[1,  2,   2,   2,   2,   2,   64], nargs='+', help='Upsample degrees for generator.')
        self._parser.add_argument('--DEGREE', type=int, default=[1,  2,   2,   2,   2,   2,  2,  2,  64], nargs='+', help='Upsample degrees for generator.')
#         self._parser.add_argument('--G_FEAT', type=int, default=[96, 256, 256, 256, 128, 128, 128, 3], nargs='+', help='Features for generator.')
        self._parser.add_argument('--G_FEAT', type=int, default=[96, 256, 256, 256, 256, 128, 128, 128, 128, 3], nargs='+', help='Features for generator.')
